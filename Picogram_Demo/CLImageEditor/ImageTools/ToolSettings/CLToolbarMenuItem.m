...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 30, W, 15)];
        _titleLabel.backgroundColor = [UIColor clearColor];
        _titleLabel.textColor = [UIColor blackColor];//[CLImageEditorTheme toolbarTextColor];
        _titleLabel.font = [UIFont fontWithName:RobotoRegular size:11.0f];//[CLImageEditorTheme toolbarTextFont];
        _titleLabel.textAlignment = NSTextAlignmentCenter;
        [self addSubview:_titleLabel];
        
        
        _iconView = [[UIImageView alloc] initWithFrame:CGRectMake(10,_titleLabel.bottom + 15, W-20, W-20)];
