...
- (void)setFilterMenu 
{
    CGFloat W = _menuScroll.height-60;//150;
    CGFloat x = 0;
    
    UIImage *iconThumbnail = [_originalImage aspectFill:CGSizeMake(100, 100)];
    ...
    for(CLImageToolInfo *info in self.toolInfo.sortedSubtools){
        ...
        CLToolbarMenuItem *view = [CLImageEditorTheme menuItemWithFrame:CGRectMake(x, 0, W, W) target:self action:@selector(tappedFilterPanel:) toolInfo:info];//_menuScroll.height-10
